...
function setup(){
  ...
  // Create canvas with img dimensions
  let canvas = createCanvas(imgRect.width, imgRect.height);
  
  // Position the canvas at the img element's location
  canvas.position(imgRect.left+50, imgRect.top);
...
function windowResized(){
  // Update img element position/size on resize
  imgRect = imgElement.getBoundingClientRect();
  resizeCanvas(imgRect.width, imgRect.height);
  pgTrails.resizeCanvas(imgRect.width, imgRect.height);
